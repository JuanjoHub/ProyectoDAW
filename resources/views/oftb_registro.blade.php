...
<head>
    ...
    <link rel="stylesheet" href="../CSS_OFTB/css_registro.css">
...
<body>
    ...
    <div class="container-halfs" id="test">
        ...
        <div class="left text-white text-center">
                    ...
                    <form>
                        ...
                        <div class="form-row font-weight-bold mb-2">
                            ...
                            <div class="form-group col-md-6 text-left">
                                ...
                                <input type="email" class="form-control text-white" id="inputPassword4"
                                    placeholder="peakeblinder@gmail.com">
                            </div>
                        </div>
                        ...
                        <div class="form-row font-weight-bold mb-2">
                            <div class="form-group col-md-6 text-left">
                                ...
                                <input type="password" class="form-control text-white" id="inputEmail4"
                                    placeholder="Password">
                            </div>
                            <div class="form-group col-md-6 text-left mb-2">
                                <label for="inputPassword4">Confirm Password</label>
                                <input type="password" class="form-control text-white" id="inputPassword4"
                                    placeholder="Password">
                            </div>
                        </div>
                        ...
                        <div class="form-row font-weight-bold text-left">
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" class="form-control text-white text-white" id="inputEmail4"
                                    >
                            </div>
                            <div class="form-group col-md-6 text-left">
            ...
            <div class="p-4"> <a href="oftb_login.html"><i class="fa-solid fa-angles-left mr-2"></i>Back</a>
            </div>
